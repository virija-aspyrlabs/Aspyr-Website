      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-gray-600 hover:text-green-600 transition-colors">AI Agents</a></li>
              <li><a href="#" className="text-gray-600 hover:text-green-600 transition-colors">Low Code Tools</a></li>
              <li><a href="#" className="text-gray-600 hover:text-green-600 transition-colors">Config Pages</a></li>
              <li><a href="#" className="text-gray-600 hover:text-green-600 transition-colors">Insurance Services</a></li>
            </ul>
          </div>
        ...
        <div className="pt-8 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          ...
          <div className="flex space-x-6 text-sm">
            ...
            <a href="#" className="text-gray-500 hover:text-green-600 transition-colors">Cookies</a>
          </div>
        </div>
      </div>
    </footer>
