...
export function Services() {
  return (
    <section id="services" className="py-20 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-white via-blue-50/50 to-white -z-20" />
      ...
      <div className="absolute top-1/4 right-10 w-72 h-72 bg-saas-300/20 rounded-full blur-3xl -z-10 animate-pulse-slow" />
      <div className="absolute top-2/3 left-0 w-80 h-80 bg-blue-100/40 rounded-full blur-3xl -z-10 animate-pulse-slow animation-delay-500" />
      <div className="absolute bottom-0 right-1/4 w-64 h-64 bg-saas-100/30 rounded-full blur-3xl -z-10 animate-pulse-slow animation-delay-700" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                  ...
                  <AnimatedCard direction="left" delay={300}>
                    <GlassCard className="px-6 py-4 max-w-xs shadow-lg">
                      <div className="flex items-center space-x-4">
                        <div className="bg-gradient-to-br from-saas-500 to-saas-600 rounded-full p-2">
          ...
          <div className="order-1 lg:order-2">
            <AnimatedCard direction="right">
              <div className="inline-block px-4 py-1.5 rounded-full bg-gradient-to-r from-saas-100 to-saas-200 text-saas-800 font-medium text-sm mb-4">
                Industry Solutions
              </div>
            </AnimatedCard>
            
            <AnimatedCard direction="right" delay={200}>
              <h2 className="text-3xl md:text-4xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-saas-800 to-saas-600">
                ...
                {[
                  ...
                  <div key={idx} className="flex">
                    <div className="flex-shrink-0 mt-1">
                      <div className="w-5 h-5 rounded-full bg-gradient-to-br from-saas-100 to-saas-200 flex items-center justify-center">
            ...
            <AnimatedCard direction="right" delay={800}>
              <Button size="lg" className="bg-gradient-to-r from-saas-500 to-saas-600 hover:from-saas-600 hover:to-saas-700 transition-all duration-300">Learn More</Button>
            </AnimatedCard>
          </div>
        </div>
      </div>
